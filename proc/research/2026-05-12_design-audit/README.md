...
| F-2 | 레이아웃 밀도 | 모바일 카드 간 여백 과다 / 정보 밀도 낮음 (홈·복습·풀이) | Med | 🟡 부분 + 차주 이월 | §3 홈 재배치([PR #20](https://github.com/curea-co/pullim-Q/pull/20))에서 일부 흡수. 나머지는 정량 기준 없어 차주 design-followup으로 이월 (2026-05-13) |
...
| F-7 | 카피 톤 | T2 / Scope L3 등 전문용어 그대로 노출 (디자인 후 보강) | Low | ✅ 닫음 | 2026-05-13 — coach-pane/onboarding/diagnose 5개 지점 학생 카피로 치환 |
...
| F-9 | 카피 톤 | TOC 한/영 혼재 ("Pattern Family" vs "패턴 친척") | Low | ✅ 닫음 | 2026-05-13 — sections.tsx 12 title + 12 anchor label 모두 한글 일관 |
...
## 미닫힘 finding 후속 처리 (2026-05-13 갱신)
| # | 상태 | 다음 작업 |
|---|---|---|
| F-2 (밀도) | 🟡 차주 이월 | 정량 기준 없어 시각 정성 판단 필요. 차주 design-followup에서 캡처 before/after 1쌍 만들고 결정 |
| F-7 (전문용어) | ✅ 닫음 (2026-05-13) | 5개 지점 학생 카피 치환 — 차주 추가 발견 시 `07-branding.md` 가이드에 흡수 |
| F-9 (TOC 한/영) | ✅ 닫음 (2026-05-13) | sections.tsx 24개 라벨 한글 일관. `04-ux-flow.md` 다이어그램 정리는 차주 |
